      ...
      <div className="flex flex-col md:flex-row h-screen ">
        <div className="md:w-1/4 bg-white py-10 px-4 md:px-10 shadow-lg">
          ...
          <div className="mt-4 md:mt-10 flex flex-wrap">
            <button
              className={`w-full mr-2 text-black mb-2 px-4 py-2 border rounded shadow-2xl hover:bg-green-400 hover:text-white  ${
            ...
            <button
              className={` w-full mr-2 text-black mb-2 px-4 py-2 border rounded shadow-2xl hover:bg-green-400 hover:text-white mt-4 ${
