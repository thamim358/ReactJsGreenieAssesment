  ...
  return (
    ...
    <div className="flex flex-col md:flex-row h-screen ">
      <div className="md:w-1/4 bg-white py-10 px-4 md:px-10 shadow-lg">
        ...
        <button
            className={`w-full mr-2 text-black mb-2 px-4 py-2 border rounded shadow-2xl hover:bg-green-500 hover:text-white  ${
              tab === "accountCreations" ? "bg-green-600 text-white" : ""
            }`}
          ...
          <button
            className={` w-full mr-2 text-black mb-2 px-4 py-2 border rounded shadow-2xl hover:bg-green-500 hover:text-white mt-4 ${
              tab === "userDetails" ? "bg-green-600 text-white" : ""
            }`}
